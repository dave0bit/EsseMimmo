...
+function ($) {
    ...
    //var str = "value";
    //document.getElementById("_area").value = str;
    ...
    ListGroup.prototype.init = function() {
        ...
        $element.on('click', '.list-group-item', function () {
            ...
            //hdnfldVariable.value = $item.attr('data-area');
            //$("#<%=hdnfldVariable.ClientID %>").val($item.attr('data-area'));
            //document.getElementById('hdnfldVariable').textContent = $item.attr('data-area');
            //alert($("#<%=hdnDataVal.ClientID %>").val(DataID));    // Here using javascr
